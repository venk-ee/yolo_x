...
class Darknet53(nn.Module):
    def __init__(self):
        ...
        self.stage3 = make_group_of_conv(
            in_channels=128, num_blocks=8
        )  # small object detection
        self.stage4 = make_group_of_conv(
            in_channels=256, num_blocks=8
        )  # medium object detection
        self.stage5 = make_group_of_conv(
            in_channels=512, num_blocks=4
...
class YOLOx(nn.Module):
    ...
    def forward(self, x):
        ...
        fpn_small, fpn_medium, fpn_large = self.fpn(
            out_feature_1, out_feature_2, out_feature_3
        )
