...
class coco_data(torchvision.datasets.VisionDataset):
    def __init__(self, root = None,split=None,anno=None ,transforms = None,):
    ...
    def __getitem__(self, index):
        ...
        if self.transforms is not None:
            transformed=self.transforms(image=image,bboxes=boxes,keypoints=keypoints)
        ...
        args = { 'boxes': boxes,
                 'image_id': torch.tensor([t['image_id'] for t in target], dtype=torch.int64), 
